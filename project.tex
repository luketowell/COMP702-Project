...
by reducing their own dependence on plastics or by wasting food\cite{asda-wastewar}. 
\\
\\
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.6]{./assets/images/gannt.png}
    {\caption*{Xpire Project Gannt Chart}}
    \label{fig:eventTrace}
\end{figure}
\end{appendix}
